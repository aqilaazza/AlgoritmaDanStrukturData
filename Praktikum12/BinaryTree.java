public class BinaryTree {
    ...
    // methode berikut akan mengunjungi dan menampilkan node-node dalam tree
    ...
    void delete (int data) { // menghapus data
        if(isEmpty()) {
            System.out.println("Tree is empty !");
        }

        // menemukan node (current) yang akan dihapus
        Node parent = root;
        Node current = root;
        ...
        //proses penghapusan ketika sudah ditemukan nodenya
        if (current == null) {
            ...
            } else if (current.left == null ) { // jika hanya ada 1 child (right)
                if(current == root) {
                    root = current.right;
                } else {
                    if (isLeftChild) {
            ...
            } else if (current.right == null) { // jika hanya ada 1 child (left)
                if(current == root) {
                    root = current.left;
                } else {
                    if (isLeftChild) {
